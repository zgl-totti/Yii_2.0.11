    ...
    <div class="m_content">
        <div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                    <li><a href="<?=\yii\helpers\Url::to(['message/unread'])?>">未读信息<font color="red">(<?=\yii\helpers\Html::encode($this->params['num1'])?>)</font></a></li>
                    <li><a href="<?=\yii\helpers\Url::to(['message/read'])?>">已读信息<font color="red">(<?=\yii\helpers\Html::encode($this->params['num2'])?>)</font></a></li>
                </ul>
            </div>
            <div class="left_m">
...
<style type="text/css">
    ...
    .m_notice{ height:35px; line-height:35px; overflow:hidden; background:url(<?=\yii\helpers\Url::to('@web/images/sp/n_not.png')?>) no-repeat left center; padding-left:32px;}
