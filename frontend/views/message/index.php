    ...
    <div style="width:720px;height:480px;">
        ...
        <div style="float:right;width:44%;height:100%;border:1px solid gray;">
            <div style="height:35px;line-height:35px;width:100%;margin-top:20px;">
                ...
                <span style="padding-left:10px;color:red"><?=\yii\helpers\Html::encode($info['lucky'])?></span>
            </div>
            <div style="height:35px;line-height:35px;width:100%;margin-top:20px;">
                <span style="padding-left:10px;">竞拍价格:</span>
                <span style="padding-left:10px;"><font color="red" size="5">￥<?=\yii\helpers\Html::encode($info['success']['price'])?> RMB</font></span>
            </div>
            <div style="height:35px;line-height:35px;width:100%;margin-top:20px;">
            ...
            <div style="height:35px;line-height:35px;width:100%;margin-top:20px;">
                ...
                <span style="padding-left:10px;"><font color="red" size="4">￥<?=\yii\helpers\Html::encode($info['success']['price'])-\yii\helpers\Html::encode($info['deposit']);?> RMB</font></span>
            </div>
