        ...
        <div id="tab1" class="tabson">
            <form action="#" id="form1">
                <ul class="forminfo">
                    ...
                    <li><label>回复内容<b>*</b></label><textarea name="replycontent" rows="15" cols="55" style="border: 1px solid #a9a9a9;margin-top: 10px;"></textarea></li>
                    <li><label>&nbsp;</label><input type="button" class="btn" value="提交"/></li>
                </ul>
            </form>
        </div>
    </div>
